...
| **2. حل الغموض بالـ Spreading Activation** | **غير موجود (Missing)** | 🔴 عالية جداً | مخطط نظري (مجدول للتطوير المستقبلي في إصدارات متقدمة) |
...
* **الوضع الحالي:** **غير مدمج**. تعتمد النسخة الحالية على مطابقة الأنماط والجذور مباشرة، مما يربط الكلمة بالمفهوم الأول المطابق لها دون حساب مستويات التنشيط أو الارتباط السياقي بين الكلمات المجاورة في الرسم البياني للرسم (Graph).
* **خطة التطوير:** مجدول لإصدار مستقبلي، حيث سيتم إدخال أوزان ارتباطية ديناميكية بين العقد، وتوزيع طاقة التنشيط (Activation Energy) لحل غموض الكلمات المشتركة لفظياً (مثل "عين" ماء vs "عين" إنسانية) بناءً على المفاهيم المجاورة النشطة.
