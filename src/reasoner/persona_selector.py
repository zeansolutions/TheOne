...
class MultilingualPersonaSelector:
    ...
    def __init__(self, personas_data, language=None):
    ...
    def detect_question_type(self, question):
        ...
        # Keywords for classification across languages
        philosophical_words = [
